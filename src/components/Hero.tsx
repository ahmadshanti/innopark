...
export default function Hero({ onStartEval }: HeroProps) {
  ...
  return (
    <section className="relative min-h-screen bg-cream overflow-hidden flex flex-col">
      ...
      {/* Main grid */}
      <div className="relative z-10 flex-1 max-w-7xl mx-auto w-full px-8 pt-28 pb-0 grid grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <div className="mb-6 leading-none">
            <motion.div
              ...
              style={{ fontFamily: "'Tajawal', sans-serif", fontSize: '88px', fontWeight: 900, lineHeight: 1 }}
              className="text-navy"
            >
              نظام
            </motion.div>
            ...
            <motion.div
              ...
              style={{ fontFamily: "'Tajawal', sans-serif", fontSize: '50px', fontWeight: 700, lineHeight: 1, marginTop: '8px' }}
              className="text-gold"
            >
              نضج الابتكار
            </motion.div>
          ...
          <motion.p
            ...
            className="text-navy/55 text-lg leading-relaxed mb-10 max-w-md"
          >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              onClick={onStartEval}
              className="bg-gold hover:bg-gold-dark text-navy font-black text-lg px-8 py-4 rounded-xl transition-colors flex items-center gap-3 shadow-lg shadow-gold/20"
            >
              ابدأ التقييم الآن
            ...
            <button onClick={() => {
                ...
                }} className="text-navy/60 hover:text-navy font-medium text-base border border-navy/15 hover:border-navy/30 px-6 py-4 rounded-xl transition-all">
              تعرّف على المعايير
            </button>
          </motion.div>
        </div>
        ...
        <div className="relative flex items-center justify-center h-[520px]">
          ...
          <motion.div
            ...
            className="absolute w-[400px] h-[400px] rounded-full border border-dashed border-navy/10"
          />
          <motion.div
            animate={{ rotate: -360 }}
            transition={{ duration: 22, repeat: Infinity, ease: 'linear' }}
            className="absolute w-[300px] h-[300px] rounded-full border border-dashed border-gold/15"
          />
          <div className="absolute w-[210px] h-[210px] rounded-full border border-navy/8" />
          ...
          >
            ...
            <motion.img
              ...
              style={{ width: '220px', height: '220px', objectFit: 'contain', transition: 'transform 0.8s cubic-bezier(0.4,0,0.2,1)', transform: spinning ? 'rotate(360deg) scale(1.08)' : 'rotate(0deg) scale(1)' }}
            />
          </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto grid grid-cols-4">
          {stats.map((s, i) => (
            <div key={i} className={`px-8 py-6 ${i < 3 ? 'grid-sep' : ''}`}>
